...
return new class extends Migration
{
    ...
    {
        Schema::create('servicenewsletter_page', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('idServiceNewsletter')->nullable();
    ...
    {
        Schema::dropIfExists('servicenewsletter_page');
    }
};
