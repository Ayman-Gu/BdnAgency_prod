<div>
    <div class="card shadow-lg border-0 mt-5 rounded-4">
        <div class="card-header text-white rounded-top-4 ">
            <h3 class="mb-0 fw-bold  fs-4 p-2">Gérer l’Affichage des Sections de Service d’Emailing</h3>
        </div>
        <div class="card-body">
            <form>
                <div class="row">
                    @foreach($sections as $section => $enabled)
                        <div class="col-md-6 col-lg-4 d-flex align-items-center mb-4 p-3 rounded-3">
                            ...
                            @can('manageDisplaySections', App\Models\ServiceEmailing::class)

                            <div class="form-check form-switch">
                                <input 
                                    class="form-check-input switch-orange shadow" 
                                    type="checkbox" 
                                    role="switch" 
                                    id="{{ $section }}"
